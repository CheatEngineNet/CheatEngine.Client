...
appears in the public surface. A request that its constructor would refuse, like the `default` `AobScanRequest` or a
tampered option, throws an `ArgumentException` before the activation check and before any Cheat Engine call.
