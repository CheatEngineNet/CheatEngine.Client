...
///         SDK binding type that owns the generated <c>RegisterLuaFunctions</c> and <c>UnregisterLuaFunctions</c>
///         methods. The Client generator reads this declaration at compile time; it never discovers modules through
...
{
	/// <summary>Gets the static SDK binding type that owns the generated Lua registration pair.</summary>
