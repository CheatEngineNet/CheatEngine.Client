...
///     reference, callback, or native handle. <see cref="ILuaClient" /> uses it to reserve the module and all export
///     names atomically for an activation before invoking <see cref="ILuaModule.Register" />.
/// </remarks>
