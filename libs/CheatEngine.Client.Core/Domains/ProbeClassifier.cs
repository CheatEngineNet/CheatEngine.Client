...
///         <see cref="IndistinguishableLuaFailureReason" />. A throwing-form generated binding of CheatEngine.SDK 2.0.0
...
internal static class ProbeClassifier
{
	...
	internal const string IndistinguishableLuaFailureReason =
		...
		"type (a generated binding raises the same exception type for all three).";
