namespace CheatEngine.Client.Repository.Tests.Infrastructure;
...
internal static class RepositoryRoot
{
	...
	/// <summary>The directory that contains <c>CheatEngine.Client.slnx</c>, found by walking up from the test binaries.</summary>
