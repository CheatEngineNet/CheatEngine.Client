...
Lua globals and its own target observation, and must remain in its own complete build output directory. It is not a
unit test or evidence that a Cheat Engine loader isolates Plugin B from Plugin A.
